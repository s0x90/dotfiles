...
-- loalien monstereader_prefix = utf8.char(0x1f30a) -- ocean wave
-- local leader_prefix = utf8.char(0x1f916) -- robot
local leader_prefix = utf8.char(0x1f47e) -- alien monster
-- local leader_prefix = utf8.char(0x1f986) -- duck
